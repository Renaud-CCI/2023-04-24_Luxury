...
class User extends \App\Entity\User implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        ...
        "\0".parent::class."\0".'admins' => [parent::class, 'admins', null],
        "\0".parent::class."\0".'candidates' => [parent::class, 'candidates', null],
        ...
        'admins' => [parent::class, 'admins', null],
        'candidates' => [parent::class, 'candidates', null],
        'email' => [parent::class, 'email', null],
        'id' => [parent::class, 'id', null],
        'password' => [parent::class, 'password', null],
        'password_confirmation' => [parent::class, 'password_confirmation', null],
