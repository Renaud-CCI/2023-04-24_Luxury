...
class __TwigTemplate_836f7950a0c9798e4276aad6e8124c81 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "password", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>";
            // line 23
            ...
            echo "</td>
                <td>";
            // line 24
            echo ((twig_get_attribute($this->env, $this->source, $context["user"], "admin", [], "any", false, false, false, 24)) ? ("Yes") : ("No"));
            echo "</td>
                <td>
                    <a href=\"";
            // line 26
...
{% endblock %}
", "user/index.html.twig", "/home/renaud/devilbox/data/www/2023-04-24_Luxury/templates/user/index.html.twig");
    }
}
