...
class __TwigTemplate_daa2f5edb58ba3c41f15498160dd50e5 extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 19
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 19, $this->source); })()), "id", [], "any", false, false, false, 19)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "admin/show.html.twig", "/home/renaud/devilbox/data/www/2023-04-24_Luxury/templates/admin/show.html.twig");
    }
}
