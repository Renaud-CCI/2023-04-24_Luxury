...
class __TwigTemplate_57444da2deb36a74c06459805dabac79 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_admin_delete', {'id': admin.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ admin.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "admin/_delete_form.html.twig", "/home/renaud/devilbox/data/www/2023-04-24_Luxury/templates/admin/_delete_form.html.twig");
    }
}
