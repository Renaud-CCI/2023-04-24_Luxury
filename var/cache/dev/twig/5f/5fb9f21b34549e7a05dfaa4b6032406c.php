...
/* base.html.twig */
class __TwigTemplate_ab5c5d88f9768201a5c67874f8b9f736 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_USER")) {
            // line 179
            echo "\t\t\t\t\t\t\t\t\t\t<li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_candidate_new", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 179, $this->source); })()), "user", [], "any", false, false, false, 179), "id", [], "any", false, false, false, 179)]), "html", null, true);
            echo "\">Profile</a></li>
\t\t\t\t\t\t\t\t\t\t";
        }
        // line 181
...
\t\t\t\t\t\t\t\t\t<a target=\"_self\" href=\"";
            // line 210
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_candidate_new", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 210, $this->source); })()), "user", [], "any", false, false, false, 210), "id", [], "any", false, false, false, 210)]), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t\t\t<span>Profile</span>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t\t";
        ...
        // line 222
        echo "\t\t\t\t\t\t\t\t";
        if ( !twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 222, $this->source); })()), "user", [], "any", false, false, false, 222)) {
            // line 223
            echo "\t\t\t\t\t\t\t\t<li class=\" dropdown\">
\t\t\t\t\t\t\t\t\t<a target=\"_self\" href=\"";
            // line 224
            ...
            echo "\"
\t\t\t\t\t\t\t\t\t\tclass=\"btn bn-lg gradient secondary btn-block waves-effect waves-light btn-register\">
\t\t\t\t\t\t\t\t\t\t<span>Sign Up</span>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<ul>
\t\t\t\t\t\t\t\t\t\t<li><a href=\"/\">Home</a></li>
\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('app_job_offer_index')}}\">Jobs Offers</a></li>
\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('show_company')}}\">About Us</a></li>
\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('show_contact')}}\">Contact</a></li>
\t\t\t\t\t\t\t\t\t\t<li>-</li>
\t\t\t\t\t\t\t\t\t\t{% if is_granted('ROLE_USER') %}
\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('app_candidate_new', {'id': app.user.id})}}\">Profile</a></li>
\t\t\t\t\t\t\t\t\t\t{% endif %}
...
\t\t\t\t\t\t\t\t{% if is_granted('ROLE_USER') %}
\t\t\t\t\t\t\t\t<li class=\" dropdown\">
\t\t\t\t\t\t\t\t\t<a target=\"_self\" href=\"{{path('app_candidate_new', {'id': app.user.id})}}\">
\t\t\t\t\t\t\t\t\t\t<span>Profile</span>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t{% endif %}
...
\t\t\t\t\t\t\t\t{% if not app.user %}
\t\t\t\t\t\t\t\t<li class=\" dropdown\">
\t\t\t\t\t\t\t\t\t<a target=\"_self\" href=\"{{path('register')}}\"
\t\t\t\t\t\t\t\t\t\tclass=\"btn bn-lg gradient secondary btn-block waves-effect waves-light btn-register\">
\t\t\t\t\t\t\t\t\t\t<span>Sign Up</span>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</li>
